...
download.file("ftp://ftp.sanger.ac.uk/pub/project/cancerrxgene/releases/release-6.0/v17_fitted_dose_response.xlsx", destfile = "~/tmp/v17_fitted_dose_response.xlsx")
